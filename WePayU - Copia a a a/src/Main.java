...
public class Main {
    public static void main(String[] args) {
        String facade = "br.ufal.ic.p2.wepayu.Facade";
         ...
         EasyAccept.main(new String[]{facade, "tests/us3_1.txt"});  //todo bugado esse 4 erros cada
         EasyAccept.main(new String[]{facade, "tests/us4.txt"});
         EasyAccept.main(new String[]{facade, "tests/us4_1.txt"});     //estranho também 3 erros cada

           EasyAccept.main(new String[]{facade, "tests/us5.txt"});
          EasyAccept.main(new String[]{facade, "tests/us5_1.txt"});    //problema tambéeeem 3 erros cada
